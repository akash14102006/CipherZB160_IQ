...
## Executive Summary
This document provides detailed reference guidelines and system configurations for ROC and Precision-Recall Curve Analysis. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Examines trade-offs in classifier curves. Explains threshold selections designed to maximize true positives while maintaining low alert backlogs.
