...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Probability Calibration Curves. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Details calibration accuracy assessments, verifying scored probabilities map reliably to historical fraud rates.
