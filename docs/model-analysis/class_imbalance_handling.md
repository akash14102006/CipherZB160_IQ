# Class Imbalance Treatment Analysis
...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Class Imbalance Treatment Analysis. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Compares focal loss, SMOTE, and class-weight balancing methods. Finds class-weight adjustments provide best overall stability.
