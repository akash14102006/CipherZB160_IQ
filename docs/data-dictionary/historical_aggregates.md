# Customer Historical Aggregations Database Fields

* **Category**: docs/data-dictionary
* **Status**: Approved and Published
* **Updated**: June 2026
* **Version**: 1.0.0

## Executive Summary
This document provides detailed reference guidelines and system configurations for Customer Historical Aggregations Database Fields. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Field definitions for aggregated feature tables, specifying types and descriptions.
