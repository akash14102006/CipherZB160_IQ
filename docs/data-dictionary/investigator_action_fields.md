# Investigator Override Log Schema Fields
...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Investigator Override Log Schema Fields. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Field definitions for auditing tables, listing types and descriptions.
