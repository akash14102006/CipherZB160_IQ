...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Third-Party Model Risk Management. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Guidelines for assessing risk in vendor-provided black-box risk engines. Details integration and validation requirements before blending scores.
