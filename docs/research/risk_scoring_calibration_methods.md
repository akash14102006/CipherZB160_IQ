# Calibration of Machine Learning Probability Outputs
...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Calibration of Machine Learning Probability Outputs. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Compares Platt scaling and Isotonic regression for raw classifier output calibration. Emphasizes importance of calibrated probabilities for calculating financial risk metrics.
