// Tab switching engine
    ...
    const plotRiskDensity = (dataInput = riskData) => {
      ...
      const shapes = [
        { type: 'line', x0: mean, x1: mean, y0: 0, y1: 1, yref: 'paper', line: { color: '#06B6D4', width: 2, dash: 'dash' } },
        { type: 'line', x0: median, x1: median, y0: 0, y1: 1, yref: 'paper', line: { color: '#D946EF', width: 2, dash: 'dash' } },
        { type: 'line', x0: 0.60, x1: 0.60, y0: 0, y1: 1, yref: 'paper', line: { color: '#F59E0B', width: 1.5, dash: 'dot' } },
        { type: 'line', x0: 0.85, x1: 0.85, y0: 0, y1: 1, yref: 'paper', line: { color: '#EF4444', width: 1.5, dash: 'dot' } }
      ];

      const annotations = [
        { x: mean, y: 0.95, yref: 'paper', text: `Mean: ${mean.toFixed(3)}`, showarrow: false, font: { color: '#06B6D4', size: 9 }, xanchor: 'left', yanchor: 'top' },
        { x: median, y: 0.85, yref: 'paper', text: `Median: ${median.toFixed(3)}`, showarrow: false, font: { color: '#D946EF', size: 9 }, xanchor: 'left', yanchor: 'top' },
        { x: 0.60, y: 0.75, yref: 'paper', text: 'High (0.60)', showarrow: false, font: { color: '#F59E0B', size: 8 }, xanchor: 'right', yanchor: 'top' },
        { x: 0.85, y: 0.65, yref: 'paper', text: 'Critical (0.85)', showarrow: false, font: { color: '#EF4444', size: 8 }, xanchor: 'right', yanchor: 'top' }
      ];
