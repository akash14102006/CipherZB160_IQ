# LightGBM Model Tuning and Hyperparameters

* **Category**: docs/model-analysis
* **Status**: Approved and Published
* **Updated**: June 2026
* **Version**: 1.0.0

## Executive Summary
This document provides detailed reference guidelines and system configurations for LightGBM Model Tuning and Hyperparameters. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Details hyperparameter configurations for the champion LightGBM model. Includes learning rate, max depth, subsample ratios, and L1/L2 regularization.
