...
A detailed analysis of strategic objectives and compliance obligations is available in the [Business Understanding Report](../references/Business_Understanding_Report.pdf).
...
Model binaries and pipeline configurations are located in [INTELLIGENCE-LAB/models](../../../CORE/INTELLIGENCE-LAB/models/) and [INTELLIGENCE-LAB/notebooks](../../../CORE/INTELLIGENCE-LAB/notebooks/).
...
Detailed model curves comparing ROC-AUC, lift charts, and calibration parameters can be found under [model-performance](../../REPORTS-CENTER/model-performance/).
...
- **Governance Records**: [governance/](governance/)
- **Security Protocols**: [security/](security/)
...
Enterprise-grade system licensed under the [MIT License](../references/LICENSE). Prepared by the CipherZB160-IQ Team.