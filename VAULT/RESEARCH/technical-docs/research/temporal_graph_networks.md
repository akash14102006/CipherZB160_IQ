# Temporal Graph Networks for Dynamic Fraud Detection
...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Temporal Graph Networks for Dynamic Fraud Detection. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Studies time-respecting random walks over transaction graphs. Documents improvements in detection lag, allowing mule identification within minutes of first layered transaction.
