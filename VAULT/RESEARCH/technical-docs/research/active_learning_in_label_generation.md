# Active Learning for Fraud Label Generation
...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Active Learning for Fraud Label Generation. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Presents method for selecting suspicious cases for investigator review. Shows active learning cycles double model precision improvements per annotated sample.
