# Unsupervised Clustering of Transaction Behavior
...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Unsupervised Clustering of Transaction Behavior. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Details application of HDBSCAN clustering on transaction frequency, country risks, and device changes. Clusters expose previously unseen micro-typologies of fraud networks.
