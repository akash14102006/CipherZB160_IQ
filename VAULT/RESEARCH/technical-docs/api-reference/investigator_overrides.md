# Investigator Classification Override API Endpoint

* **Category**: docs/api-reference
* **Status**: Approved and Published
* **Updated**: June 2026
* **Version**: 1.0.0

## Executive Summary
This document provides detailed reference guidelines and system configurations for Investigator Classification Override API Endpoint. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
API documentation for updating risk scores with investigator feedback, specifying payloads.
