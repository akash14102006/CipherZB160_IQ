# Counterparty Account Risk Feature Fields
...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Counterparty Account Risk Feature Fields. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Field definitions for counterparty risk tables, specifying types and descriptions.
