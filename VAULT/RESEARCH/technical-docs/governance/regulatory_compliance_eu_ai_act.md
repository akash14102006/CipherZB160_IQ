# Compliance with European Union AI Act
...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Compliance with European Union AI Act. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Documents classification of the mule account detection model under AI Act risk categories. Details compliance protocols including risk management systems and user oversight.
