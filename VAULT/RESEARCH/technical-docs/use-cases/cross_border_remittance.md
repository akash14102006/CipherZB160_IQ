# Cross-Border Remittance Fraud Typlogies
...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Cross-Border Remittance Fraud Typlogies. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Analyzes money routing networks using international transfers to disperse suspicious proceeds.
