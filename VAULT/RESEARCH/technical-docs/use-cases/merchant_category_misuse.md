# Merchant Category Code Fraud Routing
...
## Executive Summary
This document provides detailed reference guidelines and system configurations for Merchant Category Code Fraud Routing. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Identifies business accounts misusing merchant classification codes to conceal transaction types.
