# LIME Local Explanation Integration Workflow
...
## Executive Summary
This document provides detailed reference guidelines and system configurations for LIME Local Explanation Integration Workflow. It serves as a certified record under the CipherZB160 IQ governance system.

## Context and Scope
Explains local feature perturbation workflows used to generate fast explanation summaries for individual account audits.
